%% load
path = "../dataset/";
dataset = load(path+"dataset_big_envelope_fusion.txt");
...
datasetupdate = [dataset(:,1), dataset(:,2), r, dataset(:,3)];

writematrix(datasetupdate, path+"dataset_big_envelope_fusion_pf.txt");
