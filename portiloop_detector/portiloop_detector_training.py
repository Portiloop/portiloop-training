...
def get_config_dict(index, split_i):
    ...
    c_dict = {'experiment_name': f'ABLATION_{ABLATION}_test_v9_implemented_on_portiloop_{index}', 'device_train': 'cuda:0', 'device_val':
        'cuda:0', 'nb_epoch_max': 500,
              'max_duration': 257400, 'nb_epoch_early_stopping_stop': 100, 'early_stopping_smoothing_factor': 0.1, 'fe': 250,
              'nb_batch_per_epoch': 1000,
              'first_layer_dropout': False,
              ...
              'reg_balancing': 'none',
              'nb_conv_layers': 4,
              'seq_len': 50, 'nb_channel': 26, 'hidden_size': 7, 'seq_stride_s': 0.15, 'nb_rnn_layers': 2, 'RNN': True,
              'envelope_input': True,
