...
conv1_kernel_input1_str = "stream_fixed_type conv1_input1_kernel[CONV1_C_OUT_SIZE][CONV1_C_IN_SIZE][CONV1_K_SIZE] = {"
for i in range(n):
...
conv1_bias_input1_str = "stream_fixed_type conv1_input1_bias[CONV1_C_OUT_SIZE] = {"
for i in range(n):
...
for layer in range(len(net.seq_input2)):
    ...
    conv2_kernel_input1_str = "stream_fixed_type conv" + str(2+layer) + "_input1_kernel[CONV" + str(2+layer) + "_C_OUT_SIZE][CONV" + str(2+layer) + "_C_IN_SIZE][CONV" + str(2+layer) + "_K_SIZE] = {"
    for i in range(n):
    ...
    conv2_bias_input1_str = "stream_fixed_type conv" + str(2+layer) + "_input1_bias[CONV" + str(2+layer) + "_C_OUT_SIZE] = {"
    for i in range(n):
...
conv1_kernel_input2_str = "stream_fixed_type conv1_input2_kernel[CONV1_C_OUT_SIZE][CONV1_C_IN_SIZE][CONV1_K_SIZE] = {"
for i in range(n):
...
conv1_bias_input2_str = "stream_fixed_type conv1_input2_bias[CONV1_C_OUT_SIZE] = {"
for i in range(n):
...
for layer in range(len(net.seq_input2)):
    ...
    conv2_kernel_input2_str = "stream_fixed_type conv" + str(2+layer) + "_input2_kernel[CONV" + str(2+layer) + "_C_OUT_SIZE][CONV" + str(2+layer) + "_C_IN_SIZE][CONV" + str(2+layer) + "_K_SIZE] = {"
    for i in range(n):
    ...
    conv2_bias_input2_str = "stream_fixed_type conv" + str(2+layer) + "_input2_bias[CONV" + str(2+layer) + "_C_OUT_SIZE] = {"
    for i in range(n):
